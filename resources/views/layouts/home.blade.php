...
<head>
  ...
  <script src="{{ asset('js/upload_image_preview.js') }}" defer></script>
        ...
        <div class="row">
          <div class="col-md-4">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ route('home.info') }}">Info</a>
              </li>

              <li class="nav-item">
                <a class="nav-link" href="{{ route('home.orders') }}">Orders</a>
              </li>
